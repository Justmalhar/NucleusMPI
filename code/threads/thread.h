...
class Thread {
  private:
    ...
    static List<Thread*> *threadTList;
    int threadID;
    static int msgCount;
  ...
  public:
    ...
    static Thread* getTByID(int threadID);
    //Get the thread by its Name
    static Thread* getTByName(string tName);
    //Get the count of messages
    int getmsgCount() { return ++msgCount;}
    //Get ID of a thread
    int getThreadId() { return threadID; }
    //Check availability of the thread
    static bool IsThreadAvailable(int threadID);
